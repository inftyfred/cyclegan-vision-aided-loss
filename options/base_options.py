...
class BaseOptions:
    ...
    def initialize(self, parser):
        ...
        parser.add_argument("--domainA", type=str, default="A", help="name for domain A (used in model filenames, e.g., latest_net_G_A.pth becomes latest_net_G_[domainA].pth)")
        parser.add_argument("--domainB", type=str, default="B", help="name for domain B (used in model filenames, e.g., latest_net_G_B.pth becomes latest_net_G_[domainB].pth)")
