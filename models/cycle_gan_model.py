...
try:
    ...
    vision_aided_loss = None
    print("Warning: vision_aided_loss not installed. Vision-aided loss will be unavailable.")
...
class CycleGANModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        if is_train:
            ...
            parser.add_argument("--cv_lambda", type=float, default=0.5, help="weight for vision-aided loss")
            ...
            parser.add_argument("--cv_warmup_iter", type=int, default=2000, help="number of warmup iterations before applying vision-aided loss (default: 0)")
    ...
    def backward_G(self):
        ...
        # combined loss and calculate gradients
        self.loss_G = self.loss_G_A + self.loss_G_B + self.loss_cycle_A + self.loss_cycle_B + self.loss_idt_A + self.loss_idt_B + self.loss_G_A_cv + self.loss_G_B_cv
